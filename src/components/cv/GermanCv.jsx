            ...
            <div className="cvs-left-site">
                ...
                <div className="cvs-skills">
                    ...
                    <div className="skills-item">
                        <ul>
                            <li>
                                <span className="li-text">Zuverlässigkeit</span>
                            </li>
                        </ul>
                    </div>
                    <div className="skills-item">
                        <ul>
                            <li>
                                <span className="li-text">Teamfähigkeit</span>
                            </li>
                        </ul>
                    </div>
                    <div className="skills-item">
                        <ul>
                            <li>
                                <span className="li-text">Sorgfalt</span>
                            </li>
                        </ul>
                    </div>
                    <div className="skills-item">
                        <ul>
                            <li>
                                <span className="li-text">Pünktlichkeit</span>
                            </li>
                        </ul>
                    </div>
                    <div className="skills-item">
            ...
            <div className="cvs-right-site">
                ...
                <div className="cvs-history">
                    ...
                    <div className="cvs-history-item">
                        ...
                        <ul>
                            <li>
                                ...
                                und Unterstützung bei der Fehlersuche und deren
                                Lösung
                            </li>
                            <li>Testen und Dokumentieren der Fehler</li>
                            <li>
                    ...
                    <div className="cvs-history-item">
                        ...
                        <p>Februar 2012 - März 2014|Berlin, Deutschland</p>
                        <ul>
                            <li>Auftragsbearbeitung</li>
                            <li>Lageristik</li>
                            <li>Datenverwalten</li>
                            <li>Buchhaltung</li>
                        </ul>
                    </div>
                    <div className="cvs-history-item">
                        ...
                        <p>Januar 2011 - Juni 2011|Pskov, Russland</p>
                        <ul>
                            <li>Produktpräsentation</li>
                            <li>Vertragsgestaltung</li>
                            <li>Organisation von Werbeaktionen</li>
                        </ul>
                    </div>
                    <div className="cvs-history-item">
                        <h3>
                        ...
                        <p>Februar 2010 - April 2010|Pskov, Russland</p>
                        <ul>
